...
class _HomeState extends State<HomePage> {
  ...
  Widget _home()=>ListView(padding:const EdgeInsets.fromLTRB(16,10,16,24),children:[
    Row(children:[ClipRRect(borderRadius:BorderRadius.circular(14),child:Image.asset('assets/rannaghor_logo.png',width:52,height:52,fit:BoxFit.cover)),const SizedBox(width:12),Expanded(child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[Text('রান্নাঘর 🍳',style:TextStyle(color:Theme.of(context).colorScheme.primary,fontWeight:FontWeight.w800,fontSize:18)),const SizedBox(height:2),Text('আজ কী রান্না করবেন?',style:Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight:FontWeight.w800))])),IconButton(onPressed:()=>widget.onThemeChanged(!widget.dark),icon:Icon(widget.dark?Icons.light_mode:Icons.dark_mode))]),
